  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 lg:p-12 mt-12 mb-24">
      ...
      <ol className="list-decimal list-inside ml-4 mb-6 text-gray-700 dark:text-gray-300 space-y-2">
        <li>
          본 서비스는 인공지능 모델을 기반으로 한 챗봇 서비스이며, <strong>당사는 챗봇이 생성하는 모든 정보의 정확성, 완전성, 신뢰성을 보증하지 않습니다.<strong>
        </li>
        <li>
          이용자는 본 서비스에서 제공하는 정보를 <strong>단순 참고 자료<strong>로만 사용하여야 하며, 중요한 결정에는 반드시 전문가의 조언을 받아야 합니다.
        </li>
        <li>
