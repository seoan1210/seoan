  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 lg:p-12 mt-12 mb-24">
      ...
      <p className="mb-6 text-gray-700 dark:text-gray-300">
        Seoan AI는 **[여기에 서안이의 챗봇이 가진 독특한 강점을 2~3줄로 설명해주세요. 예: '복잡한 코딩 문제를 쉽고 빠르게 해결해주기 위한' 또는 '최신 트렌드 정보를 요약 제공하기 위한']** 목표로 개발된 인공지능 기반의 챗봇 서비스입니다. 저희는 사용자들에게 빠르고 유용한 정보를 제공하여 일상과 업무를 돕기 위해 노력하고 있습니다.
      </p>
