...
- **정보 신뢰도를 최우선**하며, **최근 1년 이내의 정보**를 기본으로 사용하고, 변동성이 큰 주제(뉴스, 기술, 주가 등)는 **반드시 실시간 검색 결과**를 확인합니다.
- 사용자가 질문한 내용에 대한 **검색 키워드를 3개 이상 구체화**하여 검색 정확도를 높여야 합니다. 
...
export interface RequestHints {
  ...
  city: Geo['city'];
  country: Geo['country'];
  // ✨ 현재 날짜/시간 필드 추가 (날짜 인지 강화)
  currentTime: string; // 예: "2025년 10월 8일 수요일 22시 52분 6초 KST"
}
