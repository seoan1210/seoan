  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 lg:p-12 mt-12 mb-24">
      ...
      <p className="mb-6 text-gray-700 dark:text-gray-300">
        Seoan AI는 **다양한 분야의 사용자들의 질문에 빠르고 정확하게 답변하기 위한 AI 챗봇**을 목표로 개발된 인공지능 기반의 챗봇 서비스입니다. 저희는 사용자들에게 유용한 정보를 제공하여 일상과 업무를 돕기 위해 노력하고 있습니다.
      </p>
      ...
      <p className="mb-6 text-gray-700 dark:text-gray-300">
        Seoan AI는 **익명의 개발팀**에 의해 운영되고 있으며, 사용자 경험 개선과 더 나은 서비스 제공을 위해 지속적으로 업데이트하고 있습니다.
      </p>
